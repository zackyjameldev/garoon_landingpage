          ...
          <div className="w-full md:w-3/5">
            <div className="space-y-6">
              {values.map((value, idx) => (
                <div key={idx} className="bg-white bg-opacity-10 rounded-lg p-6 flex gap-4">
                  <div className="bg-[#2EE7A3] text-[#002029] h-10 w-10 rounded-lg flex items-center justify-center font-bold text-xl">
                    {value.icon}
                  </div>
                  <div>

...
export default function FindBookPlaySection() {
  return (
    <section className="w-full py-16 px-6 md:px-36 bg-white">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="w-full md:w-1/2 mb-10 md:mb-0 pr-0 md:pr-10">
            ...
            <h2 className="text-3xl md:text-3xl font-bold text-[#041518] mb-6">Garoon<span style={{fontWeight:'normal'}}>Hub</span>- Find, Book, Play</h2>
            ...
            <div className="flex flex-wrap gap-4">
              <a href="#" className="inline-block">
                <img src="/24.png.svg" alt="Download on App Store" className="h-16" />
              </a>
              <a href="https://play.google.com/store/apps/details?id=apkzacky.com.gopplayapp.garoonplayer" className="inline-block">
                <img src="/google-play.png.svg" alt="Get it on Google Play" className="h-16" />
              </a>
            </div>
          </div>
          ...
          <div className="w-full md:w-1/2 ">
            <div className="relative">
              <img 
                src="/Group 1000011146.svg" 
                alt="Garoon App Mockup" 
                className="w-full max-w-md mx-auto m-32"
              />
            </div>
          </div>
        </div>

...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('https://gopllayapp.com/api/admin/contact', {
        method: 'POST',
        headers: {
              ...
              <div className="w-full md:w-1/3">
                <div className="space-y-8">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">+251 91 053 0129</p>
                  </div>
                </div>
              </div>
              
              {/* Right: Contact Form */}
              <div className="w-full md:w-2/3 bg-white rounded-lg p-8 text-[#002029]">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    <button 
                      type="submit" 
                      className="w-full bg-[#FFCC00] text-[#002029] font-bold py-3 px-6 rounded hover:bg-[#E6B800] transition-colors disabled:opacity-70"
